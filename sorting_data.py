...
#! 1. I used sorted function to order the combined list by their lenght and the amount of items, respectively.
#! 2. To sort by the name and by the amount, I used a lambda function to avoid making a small function in more lines than one.
#! 3. To sort the name I set a variable to make the lenght find the string and then this value is attached to the sorted function, making him search for the lenght of the words.
#! 4. To sort the number, I just set the index where the numbers are and then the sort function, as he searchs on an ascending way by default, pick the smaller one in first place. 
'''