...
#! 1 I used the zip function to merge both of the lists.
#! 2 With both of lists reduced to one, I used the enumerate function to give them an ID.
...
#?? Final result:
    #* With both of the list merged with zip, the enumerate function on for loop gives an ID for each tuple of it, then:
        [ID 0] - Candy: 510
        [ID 1] - Meat: 2102
        ...
        [ID 8] - Toys: 76
